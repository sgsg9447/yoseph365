...
// ── 연락처 ────────────────────────────────────────────────────────────
export const PHONE_MAIN = "031-123-4567"; // 핸드오프 sections.jsx 상수
export const PHONE_FOOTER = "032-678-3650"; // 핸드오프 Footer 실제 번호

// ── 상담 시간 ─────────────────────────────────────────────────────────
export const CONSULT_HOURS = "평일 9:30~18:00, 점심시간 12:00~13:00";

// ── 주소 ──────────────────────────────────────────────────────────────
export const ADDRESS = "경기도 부천시 성고로 69, 2층 · 4층";
export const ADDRESS_DETAIL = "경기도 부천시 성고로 69, 2층 · 4층";
